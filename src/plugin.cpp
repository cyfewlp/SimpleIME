...
void LIBC_NAMESPACE::InitializeLogging(const spdlog::level::level_enum logLevel,
...
namespace
{
    bool PluginLoad(const SKSE::LoadInterface *skse)
    {
        ...
        try
        {
            ...
            AppConfig::LoadIni(configFilePath.c_str());
            const auto *pConfig = AppConfig::GetConfig();
...
int LIBC_NAMESPACE::ErrorHandler(unsigned int code, _EXCEPTION_POINTERS *)
{
