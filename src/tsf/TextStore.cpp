...
namespace LIBC_NAMESPACE::Tsf
{
                                ...
                                LONG *pacpResultEnd) -> HRESULT
    {
        ...
        if (const uint32_t lTextLength = m_pTextEditor->GetTextSize();
            acpTestStart > acpTestEnd || acpTestEnd > lTextLength)
        {
            return E_INVALIDARG;
        }
    ...
    {
        log_trace("TextStore::{}, {}, {}", __func__, acpStart, acpEnd);
        if (!IsLocked(TS_LF_READ))
        {
            return TS_E_NOLOCK;
        }
    ...
    {
        log_trace("TextStore::{} {}  start {}, end {}", __func__, WCharUtils::ToString(std::wstring(pchText, cch)),
                  acpStart, acpEnd);
    ...
    auto TextStore::InsertEmbedded(DWORD dwFlags, LONG acpStart, LONG acpEnd, IDataObject *pDataObject,
                                   TS_TEXTCHANGE *pChange) -> HRESULT
    {
    ...
    auto TextStore::RequestAttrsAtPosition(LONG acpPos, ULONG cFilterAttrs, const TS_ATTRID *paFilterAttrs,
                                           DWORD dwFlags) -> HRESULT
    {
        auto tracer = FuncTracer("TextStore::{}", __func__);
    ...
    auto TextStore::RequestAttrsTransitioningAtPosition(LONG acpPos, ULONG cFilterAttrs, const TS_ATTRID *paFilterAttrs,
                                                        DWORD dwFlags) -> HRESULT
    {
        auto tracer = FuncTracer("TextStore::{}", __func__);
    ...
    auto TextStore::InsertEmbeddedAtSelection(DWORD /*dwFlags*/, IDataObject * /*pDataObject*/, LONG * /*pacpStart*/,
                                              LONG * /*pacpEnd*/, TS_TEXTCHANGE * /*pChange*/) -> HRESULT
    {
        auto tracer = FuncTracer("TextStore::{}", __func__);
