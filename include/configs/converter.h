...
{
    static constexpr spdlog::level::level_enum convert(
        const char *value, spdlog::level::level_enum aDefault = spdlog::level::off
    )
    {
        if (value == nullptr)
        {
...
{
    static constexpr std::unordered_set<std::string> convert(
        const char *value, const std::unordered_set<std::string> &aDefault
    )
    {
        if (value == nullptr)
        {
