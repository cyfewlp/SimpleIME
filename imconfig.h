...
// handler (require imm32.lib/.a, auto-link for Visual Studio, -limm32 on command-line for MinGW)
...
// (clipboard, IME). #define IMGUI_ENABLE_OSX_DEFAULT_CLIPBOARD_FUNCTIONS      // [OSX] Implement default OSX clipboard
// handler (need to link with '-framework ApplicationServices', this is why this is not the default). #define
// IMGUI_DISABLE_DEFAULT_SHELL_FUNCTIONS             // Don't implement default platform_io.Platform_OpenInShellFn()
